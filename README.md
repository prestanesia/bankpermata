Bank Permata
--------
Modul pembayaran Bank Permata untuk PrestaShop 1.6.x (branch: 1.6) dan PrestaShop 1.7.x (branch: master)
...
* Rename bankpermata-master.zip menjadi bankpermata.zip
