...
$cart = $context->cart;
$bankwire = Module::getInstanceByName('bankpermata');
...
$bankwire->validateOrder($cart->id, Configuration::get('PS_OS_BANKPERMATA'), $total, $bankwire->displayName, null, array(), (int)$currency->id, false, $customer->secure_key);
